---
title: "Detecting rogues in Bayesian posterior tree samples"
...
vignette: >
  %\VignetteIndexEntry{Detecting rogues in Bayesian posterior tree samples}
...
before rogue taxa can be identified and explored.

The workflow presented here should be easily adapted for 
any Bayesian analysis, but if you hit snags or get stuck please
let me know by [filing a GitHub issue](https://github.com/ms609/Rogue/issues/new?title=Bayesian+vignette)
or by e-mail.
...
a proportion of trees as burnin:
...
Now we can look for rogue taxa in this tree set:

```{R find-rogues}
# RogueTaxa(trees) might do a better job, more slowly
...
SpectrumLegend(spectrum = colorRampPalette(c(par("fg"), "#009E73"),
                                           space = "Lab")(100),
               labels = range(positions$onEdge, positions$atNode))
```
