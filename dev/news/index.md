...
- Remove unused internal C function `LOG_GRAPH_GEODESIC_MULTI`,
  superseded by the fused `TIP_INSTABILITY` kernel.
...
- Improve performance of
  ...
  (and thence
  [`ColByStability()`](https://ms609.github.io/Rogue/dev/reference/TipInstability.md),
...
- [`Cophenetic()`](https://ms609.github.io/Rogue/dev/reference/GraphGeodesic.md)
